...
#
#  $ bin/test -s antwalk.registry -t test_department.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src antwalk.registry.testing.ANTWALK_REGISTRY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot /src/antwalk/registry/tests/robot/test_department.robot
#
